    ...
    public void ComputeFracture()
    {
        ...
        if (mesh != null)
        {
            ...
            if (this._fragmentRoot == null)
            {
                ...
                this._fragmentRoot = new GameObject($"{this.name}Fragments");
                this._fragmentRoot.transform.SetParent(this.transform.parent);
                ...
                this._fragmentRoot.transform.localScale = Vector3.one;
            }
        ...
        SetFragmentobject(_fragmentRoot);
    }

    private void SetFragmentobject(GameObject fragmentObject)
    {
        _fragmentRoot = fragmentObject;
    }

    public GameObject GetFragmentObject()
    {
